graphVis3DSphere <- function(graph, roiNames, expansion = 1.2, bend = .5, lwd = 2, col = "black", cutoff = NULL){
    ...
    for (i in 1 : length(x)) text3d(x[i] * expansion, y[i] * expansion, z[i], text = roiNames[i], cex = .75, add = TRUE)
